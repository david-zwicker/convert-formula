...
from pyparsing import (
    Literal, CaselessLiteral, Word, Combine, Optional, nums, alphas,
    upcaseTokens, replaceWith, Keyword, CaselessKeyword
)
...
class LanguagePython(LanguageBase):
    ...
    operators = { '^': '**',
                  ...
                  'arcsin': 'np.asin', 'arccos': 'np.acos', 'arctan': 'np.atan',
